CREATE DATABASE  IF NOT EXISTS `karen3` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `karen3`;
-- MySQL dump 10.13  Distrib 8.0.34, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: karen3
-- ------------------------------------------------------
...
CREATE TABLE `clientes` (
  ...
  KEY `fk_pedidos_clientes` (`id_pedido`),
...
CREATE TABLE `repartidor` (
  ...
  KEY `fk_pedidos_repartidor` (`id_pedido`),
  CONSTRAINT `fk_pedidos_repartidor` FOREIGN KEY (`id_pedido`) REFERENCES `pedidos` (`id_pedido`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ventas` (
  ...
  `id_ventas` int NOT NULL,
  `id_producto` int NOT NULL,
  KEY `fk_detallesventa_ventas` (`id_ventas`),
  KEY `fk_productos_ventas` (`id_producto`),
  CONSTRAINT `fk_detallesventa_ventas` FOREIGN KEY (`id_ventas`) REFERENCES `detallesventa` (`id_ventas`),
...
-- Dump completed on 2023-11-14 23:25:31
